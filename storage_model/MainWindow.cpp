...
bool MainWindow::MainLoop(ModelData* data) {
    ...
    button_stop = new Button(30, 800, 250, 50, L"ќстановить модель", font_text);
    button_order = new Button(30 + 250 + 15, 800, 220, 50, L"«аказать", font_text);
    button_create_requests = new Button(30 + 250 + 15, 800, 220, 50, L"ѕрин€ть заказы", font_text, 25);
    int day = 0;
    condition = 0;
